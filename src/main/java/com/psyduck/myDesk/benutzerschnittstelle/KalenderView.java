...
public class KalenderView extends VerticalLayout {
    ...
    public KalenderView(ToDoRepository toDoRepository, AktuellerBenutzerService aktuellerBenutzerService) {
    ...
    private FullCalendar erstelleKalender() {
        ...
        kalender.setOption(FullCalendar.Option.HEADER_TOOLBAR, "prev,next today title");
    ...
    private HorizontalLayout erstelleKalenderheader(FullCalendar kalender) {
        ...
        kalenderHeader.setAlignItems(FlexComponent.Alignment.CENTER);
        kalenderHeader.getStyle().set("position", "relative");

        kalenderHeader.add(navigation, monatAnzeige);
    ...
    private Component erstelleKalenderbereich() {
        ...
        VerticalLayout kalenderbereich = new VerticalLayout(kalenderHeader, kalender);
